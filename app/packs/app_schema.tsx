...
export type Billing__Customer = {
  ...
  readonly id: Scalars['ID'];
  readonly paymentMethods: ReadonlyArray<Billing__PaymentMethod>;
};

export type Billing__PaymentMethod = {
  readonly __typename?: 'Billing__PaymentMethod';
  readonly brand: Billing__PaymentMethod__Brand;
...
export enum Billing__PaymentMethod__Brand {
...
export type Billing__StripeSetupIntent = {
  readonly __typename?: 'Billing__StripeSetupIntent';
  readonly id: Scalars['ID'];
};

/** Autogenerated return type of BuildBillingPaymentMethod. */
export type BuildBillingPaymentMethodPayload = {
  readonly __typename?: 'BuildBillingPaymentMethodPayload';
...
/** Autogenerated return type of BuildStripeSetupIntentService. */
export type BuildStripeSetupIntentServicePayload = {
  readonly __typename?: 'BuildStripeSetupIntentServicePayload';
  readonly stripeSetupIntent: Billing__StripeSetupIntent;
};
...
/** Autogenerated return type of DefaultBillingPaymentMethod. */
export type DefaultBillingPaymentMethodPayload = {
  readonly __typename?: 'DefaultBillingPaymentMethodPayload';
  readonly billing: Billing;
};
...
/** Autogenerated return type of DestroyBillingPaymentMethod. */
export type DestroyBillingPaymentMethodPayload = {
  readonly __typename?: 'DestroyBillingPaymentMethodPayload';
  readonly billing: Billing;
};
...
export type Mutation = {
  ...
  readonly buildBillingPaymentMethod: BuildBillingPaymentMethodPayload;
  readonly buildBillingStripeSetupIntent: BuildStripeSetupIntentServicePayload;
  ...
  readonly defaultBillingPaymentMethod: DefaultBillingPaymentMethodPayload;
  readonly destroyAuthentication: DestroyAuthenticationPayload;
  readonly destroyBillingPaymentMethod: DestroyBillingPaymentMethodPayload;
...
export type MutationBuildBillingPaymentMethodArgs = {
...
export type MutationDefaultBillingPaymentMethodArgs = {
  id: Scalars['ID'];
};
...
export type MutationDestroyBillingPaymentMethodArgs = {
  id: Scalars['ID'];
};
...
export type Billing__Payment_MethodFragment = { readonly __typename?: 'Billing__PaymentMethod', readonly id: string, readonly number: string, readonly brand: Billing__PaymentMethod__Brand, readonly exp: string, readonly default: boolean };
...
export type BuildBillingStripeSetupIntentMutationVariables = Exact<{ [key: string]: never; }>;


export type BuildBillingStripeSetupIntentMutation = { readonly __typename?: 'Mutation', readonly result: { readonly __typename?: 'BuildStripeSetupIntentServicePayload', readonly intent: { readonly __typename?: 'Billing__StripeSetupIntent', readonly id: string } } };
...
export type SettingsBillingPaymentMethodDestroyMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type SettingsBillingPaymentMethodDestroyMutation = { readonly __typename?: 'Mutation', readonly result: { readonly __typename?: 'DestroyBillingPaymentMethodPayload', readonly billing: { readonly __typename?: 'Billing', readonly id: string, readonly customer?: { readonly __typename?: 'Billing__Customer', readonly id: string, readonly sources: ReadonlyArray<{ readonly __typename?: 'Billing__PaymentMethod', readonly id: string, readonly number: string, readonly brand: Billing__PaymentMethod__Brand, readonly exp: string, readonly default: boolean }> } | null } } };
...
export type LoginMutation = { readonly __typename?: 'Mutation', readonly login: { readonly __typename?: 'LoginMutationPayload', readonly status: Status, readonly authentication?: { readonly __typename?: 'Authentication', readonly id: string } | null, readonly errors?: { readonly __typename?: 'Errors', readonly messages: any } | null } };
...
export type SettingsBillingPaymentMethodBuildMutationVariables = Exact<{
  source: Scalars['String'];
}>;


export type SettingsBillingPaymentMethodBuildMutation = { readonly __typename?: 'Mutation', readonly result: { readonly __typename?: 'BuildBillingPaymentMethodPayload', readonly billing: { readonly __typename?: 'Billing', readonly id: string, readonly customer?: { readonly __typename?: 'Billing__Customer', readonly id: string, readonly sources: ReadonlyArray<{ readonly __typename?: 'Billing__PaymentMethod', readonly id: string, readonly number: string, readonly brand: Billing__PaymentMethod__Brand, readonly exp: string, readonly default: boolean }> } | null } } };

export type SettingsBillingPaymentMethodDefaultMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type SettingsBillingPaymentMethodDefaultMutation = { readonly __typename?: 'Mutation', readonly result: { readonly __typename?: 'DefaultBillingPaymentMethodPayload', readonly billing: { readonly __typename?: 'Billing', readonly id: string, readonly customer?: { readonly __typename?: 'Billing__Customer', readonly id: string, readonly sources: ReadonlyArray<{ readonly __typename?: 'Billing__PaymentMethod', readonly id: string, readonly number: string, readonly brand: Billing__PaymentMethod__Brand, readonly exp: string, readonly default: boolean }> } | null } } };
...
export type SignupMutation = { readonly __typename?: 'Mutation', readonly signup: { readonly __typename?: 'SignupMutationPayload', readonly status: Status, readonly authentication?: { readonly __typename?: 'Authentication', readonly id: string } | null, readonly errors?: { readonly __typename?: 'Errors', readonly messages: any } | null } };
...
export const Billing__Payment_MethodFragmentDoc = gql`
    fragment billing__payment_method on Billing__PaymentMethod {
  id
  number
  brand
  exp
...
export const NotificationFragmentDoc = gql`
  ...
  sent
    ...
    `;
export const BuildBillingStripeSetupIntentDocument = gql`
    mutation BuildBillingStripeSetupIntent {
  result: buildBillingStripeSetupIntent {
    ...
    `;
export type BuildBillingStripeSetupIntentMutationFn = Apollo.MutationFunction<BuildBillingStripeSetupIntentMutation, BuildBillingStripeSetupIntentMutationVariables>;

/**
 * __useBuildBillingStripeSetupIntentMutation__
 *
 * To run a mutation, you first call `useBuildBillingStripeSetupIntentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBuildBillingStripeSetupIntentMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [buildBillingStripeSetupIntentMutation, { data, loading, error }] = useBuildBillingStripeSetupIntentMutation({
 *   variables: {
 *   },
 * });
 */
export function useBuildBillingStripeSetupIntentMutation(baseOptions?: Apollo.MutationHookOptions<BuildBillingStripeSetupIntentMutation, BuildBillingStripeSetupIntentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<BuildBillingStripeSetupIntentMutation, BuildBillingStripeSetupIntentMutationVariables>(BuildBillingStripeSetupIntentDocument, options);
      }
export type BuildBillingStripeSetupIntentMutationHookResult = ReturnType<typeof useBuildBillingStripeSetupIntentMutation>;
export type BuildBillingStripeSetupIntentMutationResult = Apollo.MutationResult<BuildBillingStripeSetupIntentMutation>;
export type BuildBillingStripeSetupIntentMutationOptions = Apollo.BaseMutationOptions<BuildBillingStripeSetupIntentMutation, BuildBillingStripeSetupIntentMutationVariables>;
...
export const SettingsBillingPaymentMethodDestroyDocument = gql`
    mutation SettingsBillingPaymentMethodDestroy($id: ID!) {
    ...
    billing {
      ...
      customer {
        ...
        sources: paymentMethods {
          ...billing__payment_method
        }
      }
    }
  }
}
    ${Billing__Payment_MethodFragmentDoc}`;
export type SettingsBillingPaymentMethodDestroyMutationFn = Apollo.MutationFunction<SettingsBillingPaymentMethodDestroyMutation, SettingsBillingPaymentMethodDestroyMutationVariables>;

/**
 * __useSettingsBillingPaymentMethodDestroyMutation__
 *
 * To run a mutation, you first call `useSettingsBillingPaymentMethodDestroyMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSettingsBillingPaymentMethodDestroyMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [settingsBillingPaymentMethodDestroyMutation, { data, loading, error }] = useSettingsBillingPaymentMethodDestroyMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useSettingsBillingPaymentMethodDestroyMutation(baseOptions?: Apollo.MutationHookOptions<SettingsBillingPaymentMethodDestroyMutation, SettingsBillingPaymentMethodDestroyMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SettingsBillingPaymentMethodDestroyMutation, SettingsBillingPaymentMethodDestroyMutationVariables>(SettingsBillingPaymentMethodDestroyDocument, options);
      }
export type SettingsBillingPaymentMethodDestroyMutationHookResult = ReturnType<typeof useSettingsBillingPaymentMethodDestroyMutation>;
export type SettingsBillingPaymentMethodDestroyMutationResult = Apollo.MutationResult<SettingsBillingPaymentMethodDestroyMutation>;
export type SettingsBillingPaymentMethodDestroyMutationOptions = Apollo.BaseMutationOptions<SettingsBillingPaymentMethodDestroyMutation, SettingsBillingPaymentMethodDestroyMutationVariables>;
...
export const SettingsBillingPaymentMethodBuildDocument = gql`
    mutation SettingsBillingPaymentMethodBuild($source: String!) {
  result: buildBillingPaymentMethod(source: $source) {
    ...
    ${Billing__Payment_MethodFragmentDoc}`;
export type SettingsBillingPaymentMethodBuildMutationFn = Apollo.MutationFunction<SettingsBillingPaymentMethodBuildMutation, SettingsBillingPaymentMethodBuildMutationVariables>;

/**
 * __useSettingsBillingPaymentMethodBuildMutation__
 *
 * To run a mutation, you first call `useSettingsBillingPaymentMethodBuildMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSettingsBillingPaymentMethodBuildMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [settingsBillingPaymentMethodBuildMutation, { data, loading, error }] = useSettingsBillingPaymentMethodBuildMutation({
 *   variables: {
 *      source: // value for 'source'
 *   },
 * });
 */
export function useSettingsBillingPaymentMethodBuildMutation(baseOptions?: Apollo.MutationHookOptions<SettingsBillingPaymentMethodBuildMutation, SettingsBillingPaymentMethodBuildMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SettingsBillingPaymentMethodBuildMutation, SettingsBillingPaymentMethodBuildMutationVariables>(SettingsBillingPaymentMethodBuildDocument, options);
      }
export type SettingsBillingPaymentMethodBuildMutationHookResult = ReturnType<typeof useSettingsBillingPaymentMethodBuildMutation>;
export type SettingsBillingPaymentMethodBuildMutationResult = Apollo.MutationResult<SettingsBillingPaymentMethodBuildMutation>;
export type SettingsBillingPaymentMethodBuildMutationOptions = Apollo.BaseMutationOptions<SettingsBillingPaymentMethodBuildMutation, SettingsBillingPaymentMethodBuildMutationVariables>;
export const SettingsBillingPaymentMethodDefaultDocument = gql`
    mutation SettingsBillingPaymentMethodDefault($id: ID!) {
  result: defaultBillingPaymentMethod(id: $id) {
    ...
    ${Billing__Payment_MethodFragmentDoc}`;
export type SettingsBillingPaymentMethodDefaultMutationFn = Apollo.MutationFunction<SettingsBillingPaymentMethodDefaultMutation, SettingsBillingPaymentMethodDefaultMutationVariables>;

/**
 * __useSettingsBillingPaymentMethodDefaultMutation__
 *
 * To run a mutation, you first call `useSettingsBillingPaymentMethodDefaultMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSettingsBillingPaymentMethodDefaultMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [settingsBillingPaymentMethodDefaultMutation, { data, loading, error }] = useSettingsBillingPaymentMethodDefaultMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useSettingsBillingPaymentMethodDefaultMutation(baseOptions?: Apollo.MutationHookOptions<SettingsBillingPaymentMethodDefaultMutation, SettingsBillingPaymentMethodDefaultMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SettingsBillingPaymentMethodDefaultMutation, SettingsBillingPaymentMethodDefaultMutationVariables>(SettingsBillingPaymentMethodDefaultDocument, options);
      }
export type SettingsBillingPaymentMethodDefaultMutationHookResult = ReturnType<typeof useSettingsBillingPaymentMethodDefaultMutation>;
export type SettingsBillingPaymentMethodDefaultMutationResult = Apollo.MutationResult<SettingsBillingPaymentMethodDefaultMutation>;
export type SettingsBillingPaymentMethodDefaultMutationOptions = Apollo.BaseMutationOptions<SettingsBillingPaymentMethodDefaultMutation, SettingsBillingPaymentMethodDefaultMutationVariables>;
