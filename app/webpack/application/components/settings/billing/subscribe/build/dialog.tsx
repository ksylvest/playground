...
import { Billing__Plan, Billing__Product, useBuildBillingSubscriptionMutation } from "@root/app_schema";
...
export const Dialog: React.FC<{
  ...
  const [submit, { loading }] = useBuildBillingSubscriptionMutation();
