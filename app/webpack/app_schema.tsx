...
export type Billing__Customer = {
  ...
  subscriptions: Array<Billing__Subscription>,
};
...
/** Autogenerated return type of BuildBillingSubscribe */
export type BuildBillingSubscribePayload = {
   __typename?: 'BuildBillingSubscribePayload',
  status: Status,
};
...
export type Mutation = {
  ...
  buildBillingSubscribe?: Maybe<BuildBillingSubscribePayload>,
...
export type MutationBuildBillingSubscribeArgs = {
  planID: Scalars['ID']
};
...
export type BuildBillingSubscribeMutationVariables = {
  planID: Scalars['ID']
};


export type BuildBillingSubscribeMutation = (
  { __typename?: 'Mutation' }
  & { buildBillingSubscribe: Maybe<(
    { __typename?: 'BuildBillingSubscribePayload' }
    & Pick<BuildBillingSubscribePayload, 'status'>
  )> }
);
...
export const BuildBillingSubscribeDocument = gql`
    mutation BuildBillingSubscribe($planID: ID!) {
  buildBillingSubscribe(planID: $planID) {
    status
  }
}
    `;
export type BuildBillingSubscribeMutationFn = ApolloReactCommon.MutationFunction<BuildBillingSubscribeMutation, BuildBillingSubscribeMutationVariables>;

/**
 * __useBuildBillingSubscribeMutation__
 *
 * To run a mutation, you first call `useBuildBillingSubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBuildBillingSubscribeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [buildBillingSubscribeMutation, { data, loading, error }] = useBuildBillingSubscribeMutation({
 *   variables: {
 *      planID: // value for 'planID'
 *   },
 * });
 */
export function useBuildBillingSubscribeMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<BuildBillingSubscribeMutation, BuildBillingSubscribeMutationVariables>) {
        return ApolloReactHooks.useMutation<BuildBillingSubscribeMutation, BuildBillingSubscribeMutationVariables>(BuildBillingSubscribeDocument, baseOptions);
      }
export type BuildBillingSubscribeMutationHookResult = ReturnType<typeof useBuildBillingSubscribeMutation>;
export type BuildBillingSubscribeMutationResult = ApolloReactCommon.MutationResult<BuildBillingSubscribeMutation>;
export type BuildBillingSubscribeMutationOptions = ApolloReactCommon.BaseMutationOptions<BuildBillingSubscribeMutation, BuildBillingSubscribeMutationVariables>;
