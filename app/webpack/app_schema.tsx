...
export type Billing = {
  ...
  id: Scalars['ID'];
  products: Array<Billing__Product>;
};
...
export type Billing__Customer = {
  ...
  subscription?: Maybe<Billing__Subscription>;
};

export enum Billing__Interval {
  Month = 'MONTH',
  Year = 'YEAR'
}

export type Billing__Plan = {
  __typename?: 'Billing__Plan';
  amount: Scalars['Int'];
...
export type Billing__Product = {
  __typename?: 'Billing__Product';
  id: Scalars['ID'];
  name: Scalars['String'];
  plans: Array<Billing__Plan>;
};
...
export type Billing__Subscription = {
  __typename?: 'Billing__Subscription';
  id: Scalars['ID'];
  plan: Billing__Plan;
};
...
/** Autogenerated return type of BuildBillingSubscription */
export type BuildBillingSubscriptionPayload = {
  __typename?: 'BuildBillingSubscriptionPayload';
  status: Status;
};
...
export type Mutation = {
  ...
  buildBillingSubscription?: Maybe<BuildBillingSubscriptionPayload>;
...
export type MutationBuildBillingSubscriptionArgs = {
  planID: Scalars['ID'];
};
...
export type BuildBillingSubscriptionMutationVariables = Exact<{
  planID: Scalars['ID'];
}>;


export type BuildBillingSubscriptionMutation = (
  { __typename?: 'Mutation' }
  & { buildBillingSubscription?: Maybe<(
    { __typename?: 'BuildBillingSubscriptionPayload' }
    & Pick<BuildBillingSubscriptionPayload, 'status'>
  )> }
);
...
export type BillingFragment = (
  ...
  & { customer?: Maybe<(
    { __typename?: 'Billing__Customer' }
    & Billing__CustomerFragment
  )>, products: Array<(
    { __typename?: 'Billing__Product' }
    & Billing__ProductFragment
  )> }
);

export type Billing__CustomerFragment = (
  { __typename?: 'Billing__Customer' }
  ...
  & { sources: Array<(
    ...
    { __typename?: 'Billing__Subscription' }
    & Billing__SubscriptionFragment
  )> }
);

export type Billing__PlanFragment = (
  { __typename?: 'Billing__Plan' }
  & Pick<Billing__Plan, 'id' | 'amount' | 'currency' | 'interval'>
);

export type Billing__ProductFragment = (
  { __typename?: 'Billing__Product' }
  & Pick<Billing__Product, 'id' | 'name'>
  & { plans: Array<(
    { __typename?: 'Billing__Plan' }
    & Billing__PlanFragment
  )> }
);
...
export type Billing__SubscriptionFragment = (
  { __typename?: 'Billing__Subscription' }
  & Pick<Billing__Subscription, 'id'>
  & { plan: (
    { __typename?: 'Billing__Plan' }
    & Billing__PlanFragment
  ) }
...
export const Billing__SourceFragmentDoc = gql`
  ...
  default
    ...
    `;
export const Billing__PlanFragmentDoc = gql`
    fragment billing__plan on Billing__Plan {
  id
  amount
  currency
  interval
    ...
    `;
export const Billing__SubscriptionFragmentDoc = gql`
    fragment billing__subscription on Billing__Subscription {
  id
  plan {
    ...billing__plan
  }
}
    ${Billing__PlanFragmentDoc}`;
export const Billing__CustomerFragmentDoc = gql`
    fragment billing__customer on Billing__Customer {
  id
  currency
  sources {
    ...billing__source
...
${Billing__SubscriptionFragmentDoc}`;
export const Billing__ProductFragmentDoc = gql`
    fragment billing__product on Billing__Product {
  id
  name
  plans {
    ...billing__plan
...
export const BillingFragmentDoc = gql`
  ...
  products {
    ...
    ${Billing__CustomerFragmentDoc}
${Billing__ProductFragmentDoc}`;
...
export const BuildBillingSubscriptionDocument = gql`
    mutation BuildBillingSubscription($planID: ID!) {
  buildBillingSubscription(planID: $planID) {
    status
  }
}
    `;
export type BuildBillingSubscriptionMutationFn = ApolloReactCommon.MutationFunction<BuildBillingSubscriptionMutation, BuildBillingSubscriptionMutationVariables>;

/**
 * __useBuildBillingSubscriptionMutation__
 *
 * To run a mutation, you first call `useBuildBillingSubscriptionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBuildBillingSubscriptionMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [buildBillingSubscriptionMutation, { data, loading, error }] = useBuildBillingSubscriptionMutation({
 *   variables: {
 *      planID: // value for 'planID'
 *   },
 * });
 */
export function useBuildBillingSubscriptionMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<BuildBillingSubscriptionMutation, BuildBillingSubscriptionMutationVariables>) {
        return ApolloReactHooks.useMutation<BuildBillingSubscriptionMutation, BuildBillingSubscriptionMutationVariables>(BuildBillingSubscriptionDocument, baseOptions);
      }
export type BuildBillingSubscriptionMutationHookResult = ReturnType<typeof useBuildBillingSubscriptionMutation>;
export type BuildBillingSubscriptionMutationResult = ApolloReactCommon.MutationResult<BuildBillingSubscriptionMutation>;
export type BuildBillingSubscriptionMutationOptions = ApolloReactCommon.BaseMutationOptions<BuildBillingSubscriptionMutation, BuildBillingSubscriptionMutationVariables>;
