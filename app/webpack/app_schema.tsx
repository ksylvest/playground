...
export type Mutation = MutationInterface & {
   __typename?: 'Mutation',
...
export type MutationInterfaceBuildBillingSourceArgs = {
  source: Scalars['String']
};


export type MutationInterfaceDefaultBillingSourceArgs = {
  id: Scalars['ID']
};


export type MutationInterfaceDestroyBillingSourceArgs = {
  id: Scalars['ID']
};
...
export type Query = QueryInterface & {
   __typename?: 'Query',
